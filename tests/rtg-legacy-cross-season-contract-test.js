...
assert.match(cardS1,/rtg-legacy-badge/);assert.match(cardS1,/rtg-legacy-tab/);assert.match(cardS1,/data-legacy-season="S1"/);assert.match(cardS1,/>S1<\/span>/);
assert.match(cardS2,/rtg-legacy-badge/);assert.match(cardS2,/rtg-legacy-tab/);assert.match(cardS2,/data-legacy-season="S2"/);assert.match(cardS2,/>S2<\/span>/);
