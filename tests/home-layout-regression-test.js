...
for (const required of ['Nessuna run attiva', 'Scrivi la tua leggenda', 'Entra nel torneo', 'Run in corso', 'Continua la run', 'Il tuo club', 'La tua squadra', 'Gestisci squadra']) assert.match(home, new RegExp(required, 'i'));
...
for (const [id, handler] of [
  ...
  ['open-modes-home', 'renderSeasonSelect'], ['manage-team-home', 'resumeRun'],
]) {
