...
assert.match(vend,/btn btn-yellow/);assert.match(vend,/rtg-vending-machine-v5/);assert.match(vend,/>Distributore</);assert.doesNotMatch(vend,/DISTRIBUTORE S1|<small>POOL<\/small>/);
