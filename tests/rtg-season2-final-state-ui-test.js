...
const html=V.runMarkup({state:base,nodes,seasonDb:db,seasonConfig:{routeBackground:"assets/rtg/rtg-season2-route-map.webp"}});
...
assert(html.includes("--rtg-season-route-bg:url('assets/rtg/rtg-season2-route-map.webp')"));
