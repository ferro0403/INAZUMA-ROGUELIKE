...
const html=V.runMarkup({state:base,nodes,seasonDb:db,seasonConfig:{routeBackground:"assets/rtg/rtg-season2-route-map.webp?v=20260924-user-map-1"}});
...
assert(html.includes("--rtg-season-route-bg:url('assets/rtg/rtg-season2-route-map.webp?v=20260924-user-map-1')"));
