...
assert(themeCss.includes("background-image:var(--rtg-season-route-bg)!important"),"S2 theme must force the configured Season 2 artwork over the S1 !important rule");
