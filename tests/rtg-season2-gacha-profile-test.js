...
ctx.ProfiledSeasonRuntime={
 resolveProfile:(sid,pid)=>(db.profiles||[]).find(p=>String(p.profileId)===String(pid))||null,
 canonicalPlayerId:(sid,pid)=>(db.profiles||[]).find(p=>String(p.profileId)===String(pid))?.playerId||pid
};
