...
assert(css.includes('content: "⚡"'), 'user team lockup must keep the lightning identity');
assert(css.includes('content: "⚽"'), 'opponent team lockup must keep the football identity');
