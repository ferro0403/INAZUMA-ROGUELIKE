...
assert.match(renderer, /getElementById\("edit-five-team"\)\.addEventListener[\s\S]*renderFiveVFive\(\{ returnToMatch: true \}\)/, 'team editing retains its existing return flow');
...
console.log('five-match-action-panel-test: premium CTAs, preserved handlers and responsive half cards OK');
