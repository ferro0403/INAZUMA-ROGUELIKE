...
function makeContext(testMode=true) {
  ...
  c.globalThis=c; c.window=c; c.history={}; c.matchMedia=()=>({matches:false}); vm.createContext(c); for(const file of ["js/gameplay-persistence.js","js/pulls/pull-candidates.js","js/app.js"])vm.runInContext(fs.readFileSync(file,"utf8"),c);
