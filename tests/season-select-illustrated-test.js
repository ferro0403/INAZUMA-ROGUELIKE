...
assert.match(app, /const SEASON_COVER_URLS = Object\.freeze\(\{/);
assert.match(app, /ie1_s2: "https:\/\/static\.wikia\.nocookie\.net\/inazuma-eleven\/images\/9\/9b\/%28Artwork%29_Aliea_Gakuen_captains\.jpg/);
assert.match(app, /ie1_s3: "https:\/\/static\.wikia\.nocookie\.net\/inazuma-eleven-fanon/);
assert.match(app, /ie2: "https:\/\/www\.akibagamers\.it/);
...
console.log("season-select-illustrated-test: covers, compact roster and Season-only layout OK");
