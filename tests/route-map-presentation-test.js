...
assert(appJs.includes('Prossima sfida'), 'route screen keeps the minimal next challenge header');
assert(!appJs.includes('class="route-progress-panel"') && !appJs.includes('class="route-legend"'), 'route screen must not reintroduce removed progress or legend panels');
assert(!appJs.includes('Tappe superate'), 'route screen must not reintroduce the removed completed-steps copy');
