...
const cacheTokens={"account-ui":'20260831-run-local-only-pr366-2',app:'20260901-gameplay-trace-pr366-1',"cloud-restore-protocol":'20260831-run-local-only-pr366-2',"cloud-save-core":'20260831-run-local-only-pr366-2',"firebase-cloud-save":'20260831-run-local-only-pr366-2',"run-state":'20260831-run-local-only-pr366-3'};for(const [script,token] of Object.entries(cacheTokens))assert.ok(html.includes(`js/${script}.js?v=${token}`),`${script} cache-buster`);assert.ok(html.includes('js/development-account-v3.js?v=20260831-run-local-coldstart-pr366-1'));assert.ok(html.includes('js/gameplay-persistence.js?v=20260901-gameplay-trace-pr366-1'));assert.ok(html.includes('js/restore-gameplay-routing-gate.js?v=20260831-run-local-routing-pr366-1'));assert.ok(!html.includes('restore-run-replacement-policy.js'));assert.ok(!cloud.includes('InazumaRestoreRunReplacementPolicy'));
