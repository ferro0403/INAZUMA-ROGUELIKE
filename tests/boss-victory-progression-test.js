...
assert(appJs.includes("ui.pendingReward = { boss, remaining: Number(pending.rewardsRemaining || 0)") && appJs.includes("run.pendingBossVictory.rewardsRemaining = reward.remaining"), "boss rewards must be resumed from and persisted to run state");
