...
assert.equal(dev.DEVELOPMENT_RESOURCE_ASSETS.coins,"https://dxi4wb638ujep.cloudfront.net/1/k/r/e/rez8i1pp0p8.webp"); assert.equal(dev.DEVELOPMENT_RESOURCE_ASSETS.cups,"https://dxi4wb638ujep.cloudfront.net/1/k/g/t/ttzf1b8nbe.webp");
...
const source=require("fs").readFileSync("js/development-v2.js","utf8"); assert(!source.includes("rez8i1ppo0p8")); assert(!source.includes("/1/k/r/t/ttzf1b8nbe"));
