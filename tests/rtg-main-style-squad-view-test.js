...
const fakeCard={dataset:{rtgSquadPlayer:"d1",role:"DF",area:"lineup"},addEventListener(_type,fn){this.fn=fn;}};
const root={querySelector:()=>null,querySelectorAll:sel=>sel.includes("data-rtg-squad-player")?[fakeCard]:[]};
const opened=[];
view.bind(root,{onOpenPlayer:id=>opened.push(id)});
fakeCard.fn();
