...
assert.match(html, /js\/run-state\.js\?v=20260822-run-storage-1/);
assert.match(html, /js\/account-ui\.js\?v=20260802-cloud-restore-diagnostic-fix-1/);
assert.match(html, /js\/firebase-cloud-save\.js\?v=20260822-run-storage-1/);
...
assert.match(html, /js\/cloud-save-core\.js\?v=20260822-run-storage-1/);
...
assert.match(html, /js\/cloud-save-core\.js\?v=20260814-ie1-s3-1/);
