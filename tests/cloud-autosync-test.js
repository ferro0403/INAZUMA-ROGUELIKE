...
assert.match(html, /js\/run-state\.js\?v=20260811-dynamic-team-emblems-1/);
...
assert.match(html, /js\/album-progress\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(html, /js\/cloud-save-core\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(rules, /fresh\.revision == old\.revision \+ 1/); assert.match(html, /js\/album-progress\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(html, /js\/cloud-save-core\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(rules, /manifestAfter\(uid\)/); assert.match(html, /js\/album-progress\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(html, /js\/cloud-save-core\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(rules, /request\.auth\.uid == uid/);
assert.match(html, /js\/album-progress\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(html, /js\/cloud-save-core\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(rules, /fresh\.createdAt == old\.createdAt/); assert.match(html, /js\/album-progress\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(html, /js\/cloud-save-core\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(rules, /fresh\.source == old\.source/); assert.match(html, /js\/album-progress\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(html, /js\/cloud-save-core\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(rules, /fresh\.schemaVersion == old\.schemaVersion/); assert.match(html, /js\/album-progress\.js\?v=20260807-ie1-s2-runtime-fix-1/);
assert.match(html, /js\/cloud-save-core\.js\?v=20260807-ie1-s2-runtime-fix-1/);
