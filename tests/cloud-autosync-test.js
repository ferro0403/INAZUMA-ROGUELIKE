...
for (const name of ['account-ui','run-state','album-progress','development-v2','hall-of-fame','cloud-save-core','firebase-cloud-save']) assert.match(html, new RegExp(`js/${name}\\.js\\?v=20260801-cloud-sync-3`));
