...
for(const token of ["player-move-card","Fire Tornado","Fuoco","Attacco","Potenza","80"])assert(card.includes(token),`move card includes ${token}`);
...
console.log("move presentation UI: colored timeline markup, modern icons and player detail move card OK");
