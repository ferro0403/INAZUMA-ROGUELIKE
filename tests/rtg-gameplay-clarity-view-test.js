...
const result=view.resolvedEncounterMarkup({userWon:false,probability:41.2,userPlayerName:"Chauncey Slim",aiPlayerName:"Shadow",userChoiceLabel:"Difesa",aiChoiceLabel:"Shadow Stitch"});
assert.match(result,/Chauncey Slim/);assert.match(result,/Shadow/);assert.match(result,/Shadow Stitch/);assert.match(result,/data-rtg-duel-continue/);
