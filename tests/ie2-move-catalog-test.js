...
const expected={
  "1":{MF:["The Earth","shot","Mountain",95],GK:["Majin the Hand","save","Mountain",75]},
...
assert.deepStrictEqual([catalog.players["1166"].name,catalog.players["1166"].power],["Legendary Wolf",85]);
