...
const picker=view.replacementPickerMarkup({target:{playerId:"g1",player:{name:"GK One"}},role:"GK",entries:[],total:0,query:"",sourceFilter:"all",rarityFilter:"Elite",rarityOptions:["Normale","Forte","Elite"]});
