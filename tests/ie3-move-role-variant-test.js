...
assert.deepStrictEqual(move("1957","FW"),{playerId:"1957",name:"X Blast",type:"shot",element:"Fire",power:110});
assert.strictEqual(c.MatchMoveRuntime.moveForPlayer("ie1_s3","1957").name,"Soul Hand","ID-only callers keep the catalog fallback");
assert.strictEqual(c.MatchMoveRuntime.teamContribution("ie1_s3",[{playerId:"1957",position:"FW"}]).score,110);
