(function (global) {
  ...
  const SEASONS = Object.freeze({
    ...
    ie1_s2: Object.freeze({ id: "ie1_s2", name: "Inazuma Eleven 2", displaySeasonNumber: "2", database: "data/IE1_S2_season_compact.json", moves: "data/IE1_S2_moves.json", albumCollectionId: "ie1_s2" }),
    ie1_s3: Object.freeze({ id: "ie1_s3", name: "Inazuma Eleven 3", displaySeasonNumber: "3", database: "data/IE1_S3_season_compact.json", moves: "data/IE1_S3_moves.json", albumCollectionId: "ie1_s3" }),
  ...
  async function loadDatabase(seasonId = activeSeasonId) {
    ...
    if (season.id === "orion") {
      const valid = database.requiresProfileAwareRuntime === true
        && database.bossOrder?.length === 13 && database.players?.length === 309
        && database.profiles?.length === 329 && database.recruitmentPool?.entries?.length === 129
