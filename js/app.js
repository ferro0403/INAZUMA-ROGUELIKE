(function (global) {
  ...
  function devSkipCurrentBoss({ renderResult = true, expectedBossIndex = null } = {}) {
  ...
  function mountRunDevQuickTools() {
    ...
    const devBossIndex = Number(run.bossIndex || 0);
    ...
    panel.querySelector('[data-dev-run="skip"]')?.addEventListener("click", () => devSkipCurrentBoss({ expectedBossIndex: devBossIndex }));
