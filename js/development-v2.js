(function (global) {
  ...
  global.DevelopmentV2={STORAGE_KEY,SCHEMA_VERSION,SEASON_IDS,RARITIES,PROJECT_RARITIES,PROJECT_PRICES,COSTS,ASSETS,DEVELOPMENT_RESOURCE_ASSETS,empty,normalize,read,migrationStatus,migrateStoredState,write,reset,totalCups,defaultCupSelection,validateCupSelection,consumeSelectedCups,processRunEnd,purchaseProject,purchaseEmblem,addCompletedProject,nextRarity,threshold,groupEvolutionHistory,playerUpgrade,optionsFromUpgrade,permanentOptions,resolvePlayer,evolve};
