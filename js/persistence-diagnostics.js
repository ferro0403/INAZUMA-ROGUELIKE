(function (global) {
  ...
  async function repair(options = {}) {
    ...
    if (!blocker && !global.PersistenceRecoveryGuard?.isBlocked?.()) {
      for (const seasonId of RUN_IDS) {
