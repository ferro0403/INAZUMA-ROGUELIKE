(function (global) {
  ...
  function moveChance(context={}){
    ...
    let chance=base>=75?35:base>=60?55:base>=50?70:base>=35?82:90;
    ...
    if(["shot","save"].includes(String(encounterKind))) chance+=8;
    if(Number(minute)>=80&&["shot","save"].includes(String(encounterKind))) chance+=5;
    if(Number(remainingUses)===1&&Number(minute)<50) chance-=5;
