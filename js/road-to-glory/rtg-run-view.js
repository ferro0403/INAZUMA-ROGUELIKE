(function (global) {
  ...
  function create(deps = {}) {
    ...
    function vendingMarkup(model={}){const rarities=model.rarities||[],candidates=model.candidates||[],canPull=Number(model.tokens)>=300&&candidates.length>0;return `<div class="rtg-vending rtg-paper-modal"><div class="rtg-vending-title"><div><p class="eyebrow">RTG · S1</p><h2>Distributore</h2></div></div><div class="rtg-vending-stage"><div class="rtg-vending-machine-v9" data-rtg-vending-machine aria-label="Distributore di palline Season 1"><div class="rtg-vending-head-v9" aria-hidden="true"><span>CAPSULE STATION</span><strong>INAZUMA RTG</strong></div><div class="rtg-vending-window-v9" aria-hidden="true"><div class="rtg-vending-capsule-v9 c1"></div><div class="rtg-vending-capsule-v9 c2"></div><div class="rtg-vending-capsule-v9 c3"></div><div class="rtg-vending-capsule-v9 c4"></div><div class="rtg-vending-capsule-v9 c5"></div><div class="rtg-vending-capsule-v9 c6"></div><div class="rtg-vending-capsule-v9 c7"></div><div class="rtg-vending-capsule-v9 c8"></div><div class="rtg-vending-capsule-v9 c9"></div><div class="rtg-vending-capsule-v9 c10"></div><span class="rtg-vending-window-glare-v9"></span></div><div class="rtg-vending-body-v9"><div class="rtg-vending-info-v9"><small>1 CAPSULA</small><strong>300</strong></div><div class="rtg-vending-crank-v9" aria-hidden="true"><span></span></div><div class="rtg-vending-chute-v9" aria-hidden="true"><span></span></div><div class="rtg-vending-brand-v9" aria-hidden="true">RTG</div></div><div class="rtg-vending-prize-track-v9" aria-hidden="true"><span class="rtg-vending-prize-v9"></span></div></div><div class="rtg-vending-wallet-chip"><span>GETTONI</span><strong>${escape(Number(model.tokens)||0)} ◈</strong></div></div><div class="rtg-vending-ratebar" aria-label="Probabilità">${rarities.map((entry)=>`<span data-rarity="${escape(entry.rarity)}"><b>${escape(entry.rarity)}</b><em>${escape(Number(entry.weight).toFixed(1))}%</em></span>`).join("")}</div><button type="button" class="btn btn-yellow rtg-vending-pull" data-rtg-pull ${canPull?"":"disabled"}>${canPull?"GIRA · 300 ◈":candidates.length?`MANCANO ${escape(Math.max(0,300-(Number(model.tokens)||0)))} ◈`:"VINCI UNA SFIDA PER SBLOCCARE GIOCATORI"}</button></div>`;}
