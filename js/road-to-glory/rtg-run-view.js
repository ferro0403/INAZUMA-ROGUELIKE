(function (global) {
  ...
  function create(deps = {}) {
    ...
    function vendingMarkup(model={}){const rarities=model.rarities||[],candidates=model.candidates||[],canPull=Number(model.tokens)>=300&&candidates.length>0;return `<div class="rtg-vending rtg-paper-modal"><div class="rtg-vending-title"><div><p class="eyebrow">RTG · S1</p><h2>Distributore</h2></div></div><div class="rtg-vending-stage"><div class="rtg-vending-machine-v8" data-rtg-vending-machine aria-label="Distributore di palline Season 1"><div class="rtg-vending-sign-v8" aria-hidden="true"><span>INAZUMA</span><strong>RTG</strong></div><div class="rtg-vending-globe-v8" aria-hidden="true"><span class="rtg-vending-ball-v8 b1"></span><span class="rtg-vending-ball-v8 b2"></span><span class="rtg-vending-ball-v8 b3"></span><span class="rtg-vending-ball-v8 b4"></span><span class="rtg-vending-ball-v8 b5"></span><span class="rtg-vending-ball-v8 b6"></span><span class="rtg-vending-ball-v8 b7"></span><span class="rtg-vending-ball-v8 b8"></span><span class="rtg-vending-ball-v8 b9"></span><span class="rtg-vending-ball-v8 b10"></span><span class="rtg-vending-ball-v8 b11"></span><span class="rtg-vending-ball-v8 b12"></span><span class="rtg-vending-glass-shine-v8"></span></div><div class="rtg-vending-cabinet-v8"><div class="rtg-vending-price-v8"><small>1 PALLINA</small><strong>300</strong></div><div class="rtg-vending-knob-v8" aria-hidden="true"><span></span></div><div class="rtg-vending-mouth-v8" aria-hidden="true"><span></span></div></div><div class="rtg-vending-drop-v8" aria-hidden="true"><span class="rtg-vending-prize-ball-v8"></span></div></div><div class="rtg-vending-wallet-chip"><span>GETTONI</span><strong>${escape(Number(model.tokens)||0)} ◈</strong></div></div><div class="rtg-vending-ratebar" aria-label="Probabilità">${rarities.map((entry)=>`<span data-rarity="${escape(entry.rarity)}"><b>${escape(entry.rarity)}</b><em>${escape(Number(entry.weight).toFixed(1))}%</em></span>`).join("")}</div><button type="button" class="btn btn-yellow rtg-vending-pull" data-rtg-pull ${canPull?"":"disabled"}>${canPull?"GIRA · 300 ◈":candidates.length?`MANCANO ${escape(Math.max(0,300-(Number(model.tokens)||0)))} ◈`:"VINCI UNA SFIDA PER SBLOCCARE GIOCATORI"}</button></div>`;}
