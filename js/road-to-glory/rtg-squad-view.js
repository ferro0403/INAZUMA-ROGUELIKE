(function (global) {
  ...
  // Keep the established squad view intact, then extend only the replacement picker.
  document.write('<script src="js/road-to-glory/rtg-squad-view-base.js?v=20260920-overall-order-1"><\/script>');
