(function () {
  ...
  // The role switch shares the same card-sized frame as the S1/S2 badge.
  // Use the exact legacy-tab geometry, mirrored from right to left.
  const roleBadgeStyle=document.createElement("style");
  roleBadgeStyle.id="rtg-role-badge-hotfix";
  roleBadgeStyle.textContent=`
    .rtg-squad-shell .squad-bench-list > .rtg-squad-card-slot > .rtg-squad-card-frame{
      position:relative!important;
      width:100%!important;
      max-width:84px!important;
    }
    .rtg-squad-shell .squad-bench-list > .rtg-squad-card-slot > .rtg-squad-card-frame > .rtg-squad-role-trigger{
    ...
    .rtg-squad-shell .squad-bench-list > .rtg-squad-card-slot > .rtg-squad-card-frame > .rtg-squad-role-trigger span{
      display:grid!important;
      place-items:center!important;
      width:auto!important;
    ...
    .rtg-squad-shell .squad-bench-list > .rtg-squad-card-slot > .rtg-squad-card-frame > .rtg-squad-role-trigger strong{
      display:none!important;
    }
    .rtg-squad-shell .squad-bench-list > .rtg-squad-card-slot > .rtg-squad-card-frame > .rtg-squad-role-trigger:active{
  ...
  document.write('<script src="js/road-to-glory/rtg-squad-view-base.js?v=20260925-role-frame-exact-s2-1"><\/script>');
