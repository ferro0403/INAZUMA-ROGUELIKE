(function (global) {
  ...
  global.SEASON1_CONFIG = {
    ...
    itemPool: [
      ...
      { id: "intensive_training", weight: 4, kind: "consumable", name: "Allenamento intensivo", description: "Aumenta permanentemente di +3 il potenziale massimo del giocatore.", effect: "potential_boost", amount: 3 },
