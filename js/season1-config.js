(function (global) {
  ...
  global.SEASON1_CONFIG = {
    ...
    itemPool: [
      { id: "energy_drink", weight: 12, kind: "consumable", name: "Bevanda energetica", description: "Assegna +1 livello a un giocatore.", effect: "player_level", amount: 1 },
      ...
      { id: "intensive_training", weight: 4, kind: "consumable", name: "Allenamento intensivo", description: "Aumenta di +3 overall attuale e potenziale massimo del giocatore per la run corrente.", effect: "potential_boost", amount: 3 },
